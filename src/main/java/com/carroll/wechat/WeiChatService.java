...
import com.carroll.wechat.pojo.send.MessageTemplate;
import com.carroll.wechat.pojo.send.SendResult;
import com.carroll.wechat.response.TextMessage;
import com.carroll.wechat.utils.MessageUtil;
import com.carroll.wechat.utils.StringUtils;
import com.carroll.wechat.utils.WeixinUtil;
import lombok.Data;
...
public class WeiChatService {
    ...
    private void init(){
        if(handler==null){
            log.warn("请自定义消息处理接口:com.carroll.wechat.IWechatHandler");
        }
    }
...
//                return respMessage;
    ...
    public SendResult sendTextMessage(String content, List<String> toUsers) throws Exception {
        com.carroll.wechat.pojo.send.TextMessage message = new com.carroll.wechat.pojo.send.TextMessage();
